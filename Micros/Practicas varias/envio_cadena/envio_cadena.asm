...
; Practica 7	- TX Caracter
		...
		TABLA:		.DB	"IPN-ESCOM.RICARDO.RUIZ.MALDONADO$" 
					;DIRECTIVA DE TABLA PARA MANDAR DATOS SON FIJOS
					;	TODO LO QUE ESTÉ ENTRE COMILLAS SE ENVÍA
					;	NÚMERO DE CARACTERES DEBE DE SER PAR
...
ENVIA:	OUT		UDR,	R0				;;;SE TRANSMITE CARACTER

LOOP:	SBIS	UCSRA,	UDRE			;;SE ESPERA EL FIN DE TRANSMICIÓN DEL CARACTER
		RJMP	LOOP			
